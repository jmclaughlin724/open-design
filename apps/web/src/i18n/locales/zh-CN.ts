...
export const zhCN: Dict = {
  ...
  "newproj.importClaudeUrl": "导入 Claude Design 链接",
  "newproj.importClaudeUrlTitle": "从链接导入 Claude Design HTML",
  "newproj.importClaudeUrlPlaceholder": "指向 Claude Design HTML 导出的 https:// 链接",
  "newproj.importingClaudeUrl": "正在导入…",
  ...
  "designFiles.saveAsTemplate": "保存为模板",
  "designFiles.templateNameLabel": "模板名称",
  "designFiles.templateNamePlaceholder": "我导入的模板",
  "designFiles.templateNameRequired": "模板名称为必填项",
  "designFiles.intoTemplateLabel": "或添加到现有模板",
  "designFiles.intoTemplatePlaceholder": "现有模板 ID（可选）",
  "designFiles.saveTemplateAction": "保存",
  "designFiles.savingTemplate": "正在保存…",
  "designFiles.cancelTemplateAction": "取消",
  "designFiles.templateSaved": "模板已保存：{id}",
  "designFiles.templateSaveFailed": "模板保存失败：{message}",
