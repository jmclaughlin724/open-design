...
export const fa: Dict = {
  ...
  'newproj.importClaudeUrl': 'وارد کردن پیوند Claude Design',
  'newproj.importClaudeUrlTitle': 'وارد کردن HTML کلاد دیزاین از پیوند',
  'newproj.importClaudeUrlPlaceholder': 'پیوند https:// به خروجی HTML کلاد دیزاین',
  'newproj.importingClaudeUrl': 'در حال وارد کردن…',
  ...
  'designFiles.saveAsTemplate': 'ذخیره به عنوان قالب',
  'designFiles.templateNameLabel': 'نام قالب',
  'designFiles.templateNamePlaceholder': 'قالب واردشده من',
  'designFiles.templateNameRequired': 'نام قالب الزامی است',
  'designFiles.intoTemplateLabel': 'یا افزودن به قالب موجود',
  'designFiles.intoTemplatePlaceholder': 'شناسه قالب موجود (اختیاری)',
  'designFiles.saveTemplateAction': 'ذخیره',
  'designFiles.savingTemplate': 'در حال ذخیره…',
  'designFiles.cancelTemplateAction': 'لغو',
  'designFiles.templateSaved': 'قالب ذخیره شد: {id}',
  'designFiles.templateSaveFailed': 'ذخیره قالب ناموفق بود: {message}',
