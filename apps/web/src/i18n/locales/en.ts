...
export const en: Dict = {
  ...
  'newproj.importClaudeUrl': 'Import Claude Design link',
  'newproj.importClaudeUrlTitle': 'Import Claude Design HTML from a link',
  'newproj.importClaudeUrlPlaceholder': 'https:// link to a Claude Design HTML export',
  'newproj.importingClaudeUrl': 'Importing…',
  ...
  'designFiles.saveAsTemplate': 'Save as template',
  'designFiles.templateNameLabel': 'Template name',
  'designFiles.templateNamePlaceholder': 'My imported template',
  'designFiles.templateNameRequired': 'A template name is required',
  'designFiles.intoTemplateLabel': 'Or add to an existing template',
  'designFiles.intoTemplatePlaceholder': 'Existing template id (optional)',
  'designFiles.saveTemplateAction': 'Save',
  'designFiles.savingTemplate': 'Saving…',
  'designFiles.cancelTemplateAction': 'Cancel',
  'designFiles.templateSaved': 'Template saved: {id}',
  'designFiles.templateSaveFailed': 'Template save failed: {message}',
