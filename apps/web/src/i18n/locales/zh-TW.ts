...
export const zhTW: Dict = {
  ...
  "newproj.importClaudeUrl": "匯入 Claude Design 連結",
  "newproj.importClaudeUrlTitle": "從連結匯入 Claude Design HTML",
  "newproj.importClaudeUrlPlaceholder": "指向 Claude Design HTML 匯出的 https:// 連結",
  "newproj.importingClaudeUrl": "正在匯入…",
  ...
  "designFiles.saveAsTemplate": "儲存為範本",
  "designFiles.templateNameLabel": "範本名稱",
  "designFiles.templateNamePlaceholder": "我匯入的範本",
  "designFiles.templateNameRequired": "範本名稱為必填",
  "designFiles.intoTemplateLabel": "或加入現有範本",
  "designFiles.intoTemplatePlaceholder": "現有範本 ID（選用）",
  "designFiles.saveTemplateAction": "儲存",
  "designFiles.savingTemplate": "儲存中…",
  "designFiles.cancelTemplateAction": "取消",
  "designFiles.templateSaved": "範本已儲存：{id}",
  "designFiles.templateSaveFailed": "範本儲存失敗：{message}",
